   ...
   <nav class="fixed-top">
      <div class="container">
         <div class="logo">
            ...
            <h3 class="fs-3 poli fs-sm-1 fw-bolder mt-2 text-light">POLIWANGI</h3>
         </div>
         <div class="link">
            <ul>
                  ...
                  <div class="container">
                     <div class="hero">
                        <div class="teks text-light">
                           ...
                           <div class="kata">
                              <h3 class="text-hero text-center text-md-start">Selamat Datang Di Web Pengaduan Mahasiswa Politeknik Negeri Banyuwangi</h3>
                              <h3 class="text-hero text-center text-md-start">Silahkan Registrasi Atau Login dengan Akun Anda</h3>
                           </div>
                           <div class="btnn">
