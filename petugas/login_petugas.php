      ...
      <div class="row d-flex align-items-center justify-content-center" style="height: 100vh;">
         <div class="col-4">
            ...
            if (isset($_POST["login"])) {
               ...
               $login = LoginPetugas($username, $password);
               if ($login == 0) {
                  echo '<h4 class="text-center mb-4 text-danger">Login GAGAL</h4>';
               } else if ($login == 1) {
                  echo '<h4 class="text-center mb-4 text-success">Login Berhasil</h4>';
                  echo "<meta http-equiv='refresh' content='2;url=halaman_admin.php'>";
               } else if ($login == 2) {
                  echo '<h4 class="text-center mb-4 text-success">Login Berhasil</h4>';
                  echo "<meta http-equiv='refresh' content='2;url=halaman_petugas.php'>";
               }
            }
            ?>
            <form method="post" action="">
               <div class="mb-4">
                  <input type="text" name="username" class="form-control" style="border-radius: 17px;" aria-describedby="emailHelp" placeholder="Masukkan Username">
               </div>
               <div class="mb-4">
