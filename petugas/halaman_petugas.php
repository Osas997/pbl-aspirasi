            ...
            <div class="container">
               <div class="hero">
                  <div class="teks text-light">
                     ...
                     ?>
                     <h1 class="text-start">Selamat Datang <?= $dataPetugas["nama_petugas"] ?></h1>
                     ...
                     <button class="btn-tod fs-6">PETUGAS</button>
                  </div>
               </div>
            </div>
         </div>
                  ...
                  foreach ($dataPengaduan as $pengaduan) { ?>
                     <tr>
                        ...
                        <td class="ms-4">
                           ...
                           <a href="tanggapi_petugas.php?id=<?= $pengaduan['id_pengaduan'] ?>" class="d-block btn btn-primary mb-2">Tanggapi</a>
