...
<body>
   ...
   <section id="pengaduan">
      ...
      if ($cekTanggapan == true) { ?>
         <div class="container">
            <?php
            $dataPetugas = getUserPetugas();
            ?>
            <form action="" method="post" enctype="multipart/form-data">
               <input type="hidden" name="idPetugas" value="<?= $dataPetugas["id_petugas"] ?>">
               <div class="row d-flex justify-content-center mb-4">
                  <div class="col-md-4 col-12">
                     <div class="form-outline">
                        <input type="text" value="<?= $dataPetugas["nama_petugas"] ?>" id="form6Example1" class="form-control" name="namaPetugas" readonly />
                        <label class="form-label" for="form6Example1">Nama Petugas</label>
                     </div>
                  </div>
                  <div class="col-md-4 col-12">
                     <div class="form-outline">
                        <input type="text" value="<?= $dataPetugas["no_hp_ptgs"] ?>" id="form6Example1" class="form-control" name="noHpPetugas" readonly />
      ...
      <?php } else { ?>
         <h1 class="text-center text-danger p-3">SUDAH DITANGGAPI</h1>
      <?php } ?>
   </section>
   <?php
   ...
   if (isset($_POST["kirim"])) {
      buatTanggapan($_POST);
      echo "<meta http-equiv='refresh' content='1;url=halaman_petugas.php'>";
   }
